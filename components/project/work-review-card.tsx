          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <CardTitle className="flex items-center gap-2 text-sky-900">
                <RiCheckLine className="h-6 w-6 text-sky-600" />
        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-md border-4 border-sky-500 bg-sky-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <Heading variant="h3" className="text-sm font-bold text-sky-900">
                  REVIEW THE WORK
                </Heading>
                <Text variant="body" className="mt-1 text-sm text-sky-800">
              ...
              <div className="mt-3 flex items-center justify-center gap-2">
                {[1, 2, 3, 4, 5].map((star) => {
                  ...
                  return (
                    ...
                    >
                      {isFilled ? (
                        <RiStarFill className="h-10 w-10 text-sky-400" />
                      ) : (
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                {expertRating && (
                  <div className="flex items-center gap-1">
                    <RiStarFill className="h-4 w-4 text-sky-400" />
        ...
        <AlertDialogContent className="border-4 border-black sm:max-w-[600px]">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="bg-red-400 text-black border-4 border-black hover:bg-orange-500"
            >
