    ...
    <>
      <Card variant="outlined" className="border-4 border-cyan-500 bg-cyan-50">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Instructions */}
          <div className="rounded-md border-4 border-blue-500 bg-blue-50 p-4">
            <div className="flex items-start gap-3">
              <RiErrorWarningLine className="h-5 w-5 flex-shrink-0 text-blue-600" />
              <div className="flex-1">
                <Heading variant="h3" className="text-sm font-bold text-blue-900">
                  REVIEW THE WORK
                </Heading>
                <Text variant="body" className="mt-1 text-sm text-blue-800">
              ...
              <div className="mt-3 flex items-center justify-center gap-2">
                {[1, 2, 3, 4, 5].map((star) => {
                  ...
                  return (
                    ...
                    >
                      {isFilled ? (
                        <RiStarFill className="h-10 w-10 text-blue-400" />
                      ) : (
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                {expertRating && (
                  <div className="flex items-center gap-1">
                    <RiStarFill className="h-4 w-4 text-blue-400" />
