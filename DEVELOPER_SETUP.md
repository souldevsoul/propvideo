# Developer Setup Guide - PropVideo

Welcome to PropVideo! This guide will help you get started as a new developer on this project.
...
> "Hi! I'm starting on PropVideo. I need:
...
**If you see errors:**
- Make sure you're in the `propvideo` folder: `pwd` (should show the path to propvideo)
...
1. **Make sure you're in the project folder:**
   ```bash
   cd ~/Documents/propvideo  # Or wherever you cloned it
   ```
...
2. **Start Claude Code:**
   ...
   Working directory: /path/to/propvideo
   Type 'exit' to quit.
   ```
...
PropVideo uses a **warm, playful, pet-friendly** design system:
...
PropVideo implements a Human-in-the-Loop approach where certain portraits can be assigned to human executors for manual review or enhancement.
