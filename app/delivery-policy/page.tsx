        ...
        <Container maxWidth="xl">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiTruckLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-sky-50 border-4 border-black">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-3">
                    Contact <a href="mailto:support@propvideo.ai" className="font-bold underline hover:no-underline">support@propvideo.ai</a> to verify service availability in your region.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiCheckLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-sky-50 border-4 border-black">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-black font-bold">•</span>
                      <span>Real-time status updates at status.propvideo.ai</span>
                    </li>
                  </ul>
                </div>

                <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                  <h3 className="text-lg font-bold uppercase mb-3 text-sky-400">Unplanned Outages</h3>
            ...
            <div>
              <div className="p-8 bg-sky-400 border-4 border-black brutalist-shadow">
                ...
                <p className="text-gray-900 leading-relaxed mt-4">
                  Contact: <a href="mailto:enterprise@propvideo.ai" className="underline hover:no-underline font-bold">enterprise@propvideo.ai</a>
                </p>
              </div>
            </div>
              ...
              <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                ...
                <ol className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>Check status.propvideo.ai for any ongoing service issues</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="font-bold text-sky-400">5.</span>
                    <span>Contact support@propvideo.ai immediately - we'll resolve within 24 hours</span>
                  </li>
                </ol>
              </div>
            </div>
              ...
              <div className="p-8 bg-white border-4 border-black brutalist-shadow text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    ...
                    <a href="https://status.propvideo.ai" className="underline hover:no-underline" target="_blank" rel="noopener noreferrer">
                      status.propvideo.ai
                    </a>
                  </p>
                </div>
