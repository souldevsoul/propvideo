            ...
            <div className="space-y-8 text-gray-700">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="p-6 border-4 border-black bg-sky-50">
              ...
              <section>
                ...
                <div className="mt-6 p-6 border-4 border-black bg-black text-white">
                  <h3 className="text-lg font-bold uppercase mb-3 text-sky-400">Browser Cookie Settings</h3>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Google Privacy Policy: <a href="https://policies.google.com/privacy" className="text-sky-600 hover:underline">policies.google.com/privacy</a></li>
                  <li>Facebook Data Policy: <a href="https://www.facebook.com/privacy" className="text-sky-600 hover:underline">facebook.com/privacy</a></li>
                  <li>Stripe Privacy Policy: <a href="https://stripe.com/privacy" className="text-sky-600 hover:underline">stripe.com/privacy</a></li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="mt-4 p-6 border-4 border-black bg-white">
                  <p><strong>Email:</strong> privacy@propvideo.ai</p>
