        ...
        <Container maxWidth="xl">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiCloseLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-sky-50 border-4 border-black">
                  <h3 className="text-lg font-bold uppercase mb-3">Cancel Via Email</h3>
                  <p className="text-gray-700 leading-relaxed mb-3">
                    Alternatively, send an email to{" "}
                    <a href="mailto:support@propvideo.ai" className="font-bold underline hover:no-underline">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiTimeLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                  <h3 className="text-lg font-bold uppercase mb-3 text-sky-400">After Billing Period Ends</h3>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiAlertLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-sky-50 border-4 border-black">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Enterprise customers should refer to their specific contract terms. Contact your account manager or email enterprise@propvideo.ai for cancellation procedures.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                <h2 className="text-2xl font-bold uppercase mb-4 text-sky-400">
                  DATA RETENTION AFTER CANCELLATION
                </h2>
                <div className="space-y-3">
                  <p className="leading-relaxed">
                    <span className="font-bold text-sky-400">Account Data:</span> Retained for 90 days, then deleted if subscription not renewed
                  </p>
                  <p className="leading-relaxed">
                    <span className="font-bold text-sky-400">Voice Clones:</span> Retained for 90 days, accessible if you resubscribe
                  </p>
                  <p className="leading-relaxed">
                    <span className="font-bold text-sky-400">Generated Audio:</span> Automatically deleted 30 days after cancellation
                  </p>
                  <p className="leading-relaxed">
                    <span className="font-bold text-sky-400">Billing History:</span> Retained for 7 years for legal/tax compliance
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-8 bg-white border-4 border-black brutalist-shadow text-center">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a href="mailto:support@propvideo.ai" className="underline hover:no-underline">
                      support@propvideo.ai
                    </a>
                  </p>
                  <p>
