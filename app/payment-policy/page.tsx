        ...
        <Container maxWidth="xl">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiSecurePaymentLine className="w-6 h-6 text-sky-400" />
                </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiMoneyDollarCircleLine className="w-6 h-6 text-sky-400" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                  <h3 className="text-lg font-bold uppercase mb-3 text-sky-400">No Minimum or Maximum Transaction Amounts</h3>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-black border-4 border-black flex items-center justify-center">
                  <RiShieldCheckLine className="w-6 h-6 text-sky-400" />
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                  <h3 className="text-lg font-bold uppercase mb-3 text-sky-400">Email Notifications</h3>
                  <p className="leading-relaxed">
            ...
            <div>
              <div className="p-8 bg-sky-400 border-4 border-black brutalist-shadow">
                ...
                <p className="text-gray-900 leading-relaxed">
                  For questions about taxes, contact: <a href="mailto:billing@propvideo.ai" className="underline hover:no-underline font-bold">billing@propvideo.ai</a>
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="p-6 bg-black text-white border-4 border-black shadow-lg">
                ...
                <p className="leading-relaxed mb-4">
                  <span className="font-bold">Contact us first:</span> If you see an unexpected charge, please contact us at support@propvideo.ai before initiating a chargeback. We can often resolve issues quickly.
                </p>
                <p className="leading-relaxed mb-4">
            ...
            {/* Contact */}
            <div>
              <div className="p-8 bg-sky-50 border-4 border-black text-center">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a href="mailto:billing@propvideo.ai" className="underline hover:no-underline">
                      billing@propvideo.ai
                    </a>
                  </p>
                  <p>
